...
export const metadata: Metadata = createPageMetadata({ title: "자동차 비용 계산기", description: "차량 구매비, 할부이자, 유지비와 중고차 가치를 반영해 총소유비용과 보유기간의 투자 기회비용을 계산합니다.", path: "/calculators/car-cost", keywords: ["자동차 유지비 계산기", "차량 총비용 계산기", "자동차 기회비용"] });
