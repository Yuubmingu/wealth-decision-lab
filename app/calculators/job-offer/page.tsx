...
export const metadata: Metadata = createPageMetadata({ title: "이직 오퍼 자산가속 계산기", description: "급여, 성과급, 복지와 직장 관련 비용을 반영해 이직 오퍼의 실질 가치와 15년 자산효과를 비교합니다.", path: "/calculators/job-offer", keywords: ["이직 연봉 비교", "오퍼 비교 계산기", "성과급 기대값 계산"] });
