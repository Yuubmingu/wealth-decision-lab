...
export const metadata: Metadata = createPageMetadata({ title: "부의 성장 레버 실행보드", description: "소득, 저축률, 투자금, 수익률, 부채와 부업소득 중 목표자산에 가장 큰 영향을 주는 행동을 계산합니다.", path: "/tools/growth-board" });
